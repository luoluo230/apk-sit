...
$adminScript = Join-Path $root "release_bundles\admin-backend\start_admin.ps1"
$forumScript = Join-Path $root "release_bundles\forum-backend\start_forum.ps1"
$playerStaticScript = Join-Path $root "release_bundles\player-static\serve_static.ps1"
