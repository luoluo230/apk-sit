...
使用说明见：`START_HERE.md` 与 `portals/README.md`
...
| 文档 | 说明 |
|------|------|
| [portals/common/docs/DEPLOY.md](portals/common/docs/DEPLOY.md) | 部署与迁移、外网访问、HTTPS 与安全 |
| [portals/common/docs/PRODUCTION_CHECKLIST.md](portals/common/docs/PRODUCTION_CHECKLIST.md) | 商业级生产清单（兼容性、可配性、安全、可迁移性） |
| [portals/common/docs/TECHNICAL_SPECIFICATION_COMMERCIAL.md](portals/common/docs/TECHNICAL_SPECIFICATION_COMMERCIAL.md) | 商业级技术方案（跨平台、测试、备份、API 文档） |
| [portals/common/docs/PROJECT_PLAN_COMMERCIAL.md](portals/common/docs/PROJECT_PLAN_COMMERCIAL.md) | 商业级项目策划案 |
| [portals/common/reports/README_ARCHITECTURE.md](portals/common/reports/README_ARCHITECTURE.md) | 架构与模块说明 |
