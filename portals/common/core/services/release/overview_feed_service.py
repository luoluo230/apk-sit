...
def build_overview_kpis(
    ...
    return {
        ...
        "links": {
            "release_hub": f"/admin/projects/{project_id}/release-hub?env_key={env_for_link}",
            "version": f"/admin/projects/{project_id}/release-hub?env_key={env_for_link}",
            "health": f"/admin/projects/{project_id}/environments/{env_for_link}/runtime",
            "builds": f"/admin/projects/{project_id}/release-hub?env_key={env_for_link}",
            "changes": f"/admin/projects/{project_id}/release-hub?env_key={env_for_link}",
