...
class BuildTriggerUnifiedTests(unittest.TestCase):
    ...
    def test_request_build_pulls_pipeline_from_group(self):
        ...
        with mock.patch.object(oc, "get_release_order", return_value=fake_order), \
             mock.patch.object(obs, "_find_version", return_value=fake_version), \
            ...
            with mock.patch.object(obs, "_event"):
    ...
    def test_ensure_draft_release_order_returns_existing(self):
        ...
        with mock.patch.object(oc, "find_draft_release_order", return_value=existing):
