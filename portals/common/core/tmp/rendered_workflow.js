    ...
    var PROJECT_ID = "GomeKu";
    var VERSION_ID = "6159ee22";
    var CHANNEL_ID = "";
    var STAGE_ID = "";
    var VERSION_MODE = "commercial";
    var PREFERRED_INSTANCE_ID = "";
    var VERSION_LOCK_PARAMS = true;
    var CANONICAL_VERSION_NAME = "1.0.0";
    var CANONICAL_VERSION_CODE = "1";
    var CANONICAL_GIT_BRANCH = "codex/replace-logging-with-custom-logger-fvtg9m";
    var CANONICAL_UNITY_VERSION = "6000.3.8f1";
    var VERSION_PIPELINE = {"apk_build": {"app_name": "", "enabled": false, "git_branch": "codex/replace-logging-with-custom-logger-fvtg9m", "output_base_dir": "", "unity_version": "6000.3.8f1"}, "config_export": {"client_version": "1.0.0", "enabled": true, "environment": "Development", "include_code": false, "platform": "android", "remote_prefix": "MyGame1"}, "git_branch": "codex/replace-logging-with-custom-logger-fvtg9m", "hot_release": {"code_compression": "Zip", "code_enabled": true, "code_encryption": "Aes", "code_signature": "builtin-signature", "code_units": "aotmeta, hotupdate, scriptpatch, symbols", "enabled": true, "release_channel": "wechat", "release_compression_override": "", "release_encryption_override": "", "release_environment": "Development", "release_hot_labels": "hotupdate,aotmeta", "release_mode": "build-upload", "release_rollback_target": "", "release_signature_override": "", "release_targets": "code,resource", "release_upload_mode": "incremental", "resource_compression": "None", "resource_enabled": true, "resource_encryption": "None", "resource_signature": "builtin-signature", "resource_units": "addressable, hotupdate, optional, platform, hd, streaming"}, "resource_build": {"enabled": true, "provider": "addressables-v2", "scenario": "default"}};
    var VERSION_INFO = {"channel": "1001", "channel_name": "\u5fae\u4fe1", "platform": "android", "project_id": "GomeKu", "stage": "dev", "stage_name": "\u5f00\u53d1", "version_code": "1", "version_name": "1.0.0"};
    var INSTANCE_META = {};
    ...
    function loadHistory(){
        ...
        var currentInstanceId = selectedInstanceId();
        if(currentInstanceId){ q += '&instance_id=' + encodeURIComponent(currentInstanceId); }
    ...
    function resumeVersionBuild(){
        ...
        loadHistory().then(function(d){
            ...
            if(active&&active.build_number){
                ...
                // 仅当 active_build 在当前版本历史中存在时才恢复，避免串到其他平台/版本的旧缓存构建号。
                if(!target){ clearActiveBuild(); }
            }
