...
def _normalize_release_entry(payload: Dict[str, Any], project_id: str = "") -> Dict[str, Any]:
    ...
    return {
        ...
        "resource_server_url": str(payload.get("resource_server_url") or "").strip(),
        "resource_path": str(payload.get("resource_path") or "").strip(),
        "config_path": str(payload.get("config_path") or "").strip(),
        "catalog_file_name": str(payload.get("catalog_file_name") or "").strip(),
    ...
    return jsonify(
        {
            ...
            "artifact_targets": precheck.get("artifact_targets"),
