...
def resolve_runtime_version():
    """Removed in P2-02 — use GET /api/public/runtime-bootstrap."""
    body = {
        'ok': False,
        'error': 'version_resolve_removed',
        'message': '此 API 已移除，请使用 GET /api/public/runtime-bootstrap',
        'prefer_runtime_bootstrap': '/api/public/runtime-bootstrap',
        'migration': 'docs/client_bootstrap_contract.md',
    }
