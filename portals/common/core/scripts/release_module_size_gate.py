...
LIMITS = {
    ...
    "services/release/order_build_sync.py": 780,
    "services/release/order_publish_flow.py": 800,
    "services/release/channel_journey_bff.py": 680,
    "services/release/order_diagnostics.py": 520,
    "routes/commercial_release_routes.py": 150,
    "routes/project_delivery.py": 80,
    "routes/delivery/helpers.py": 180,
    "routes/delivery/pages.py": 460,
    "routes/delivery/scope_api.py": 320,
    "routes/delivery/journey_api.py": 140,
    "routes/delivery/release_orders_api.py": 120,
