...
<div style="width:120px;flex-shrink:0;"><span style="display:block;font-size:11px;color:#64748b;line-height:1.3;margin-bottom:2px;"><span style="color:#f43f5e;">*</span>版本名</span><input id="versionName" class="w-full px-2 py-1.5 border border-slate-200 rounded text-sm bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition" placeholder="1.0.0" value="1.0.0"></div>
...
<div class="flex gap-2"><div style="flex:2;"><span style="display:block;font-size:11px;color:#64748b;line-height:1.3;margin-bottom:2px;">安装包路径</span><input id="versionApkPath" class="w-full px-2 py-1.5 border border-slate-200 rounded text-sm bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition" placeholder="输出或下载路径"></div><div style="flex:1;"><span style="display:block;font-size:11px;color:#64748b;line-height:1.3;margin-bottom:2px;">资源路径</span><input id="versionResourcePath" class="w-full px-2 py-1.5 border border-slate-200 rounded text-sm bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition" placeholder="资源目录"></div><div style="flex:1;"><span style="display:block;font-size:11px;color:#64748b;line-height:1.3;margin-bottom:2px;">配置路径</span><input id="versionConfigPath" class="w-full px-2 py-1.5 border border-slate-200 rounded text-sm bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition" placeholder="配置目录"></div></div>
